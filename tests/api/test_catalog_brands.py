...
class TestAPI(unittest.TestCase):
    ...
    def test_get_catalog_brands(self):
        ...
        expected_brands = {"AirStrider", "B&R", "Daybird", "Gravitator", "Green Equipment", "Grolltex", "Legend", "Quester", "Raptor Elite", "Solstix", "WildRunner", "XE", "Zephyr"}
        actual_brands = set()
        ...
        self.assertTrue(expected_brands.issubset(actual_brands), f"Expected brands not found in response: {expected_brands - actual_brands}")