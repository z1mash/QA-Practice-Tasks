...
class RequestSender:
    ...
    @staticmethod
    @allure.step('Send PUT request to catalog items endpoint')
    ...
    @staticmethod
    @allure.step('Send POST request to catalog items endpoint')
    ...
    @staticmethod
    @allure.step('Send GET request to catalog items by IDs endpoint')
    ...
    @staticmethod
    @allure.step('Send GET request to catalog item by ID endpoint')
    ...
    @staticmethod
    @allure.step('Send DELETE request to catalog item by ID endpoint')
    def send_delete_catalog_item_by_id(params):
        url = f"{BASE_URL}{CATALOG_ITEM_BY_ID_ENDPOINT.format(id=params['id'])}?api-version={params['api-version']}"
        return requests.delete(url)

    @staticmethod
    @allure.step('Send GET request to catalog items by name endpoint')
    ...
    @staticmethod
    @allure.step('Send GET request to catalog item by picture endpoint')
    ...
    @staticmethod
    @allure.step('Send GET request to catalog items with semantic relevance endpoint')
    ...
    @staticmethod
    @allure.step('Send GET request to catalog items by type and brand endpoint')
    ...
    @staticmethod
    @allure.step('Send GET request to catalog items by brand endpoint')
    ...
    @staticmethod
    @allure.step('Send GET request to catalog types endpoint')
    ...
    @staticmethod
    @allure.step('Send GET request to catalog brands endpoint')
